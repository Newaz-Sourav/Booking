                ...
                <div class="p-[4%] border-[#ddd9d9b4] border-[1px] rounded-[8px] shadow-[0px_2px_12px_#ddd9d9]">
                  ...
                  <div>
                    ...
                    <div
                      ...
                      className={`${isSelected? "flex justify-between items-center mb-[5%] px-[3%] py-[2%] border-[#5B4DB8] hover:border-[#5B4DB8] border-[4px] rounded-[5px]" : "flex justify-between items-center mb-[5%] px-[3%] py-[2%] border-[#ddd9d9b4] hover:border-[#5B4DB8] border-[2px] rounded-[5px]" }`}
                    ...
                    <div class="w-[100%] flex justify-center items-center pb-[2%]">
                      ...
                      <button
                        ...
                        className={`px-4 py-2 ${!isSelected || isDisabled ? "btn-block w-[100%] bg-gray-400 hover:bg-[#5B4DB8] text-[16px] rounded-[5px] text-[red] border-transparent cursor-not-allowed" : "btn btn-block w-[100%] bg-[#5B4DB8] hover:bg-[#5B4DB8] text-[16px] rounded-[5px] text-[white] border-transparent"
                          } rounded`}>
